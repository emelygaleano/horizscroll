...
const char PALETTE[32] = { 
  0x3C,			// background color

  0x0D,0x1A,0x29,0x00,	// ladders and pickups
  0x0D,0x1A,0x29,0x00,	// floor blocks
  0x0D,0x1A,0x29,0x00,
  0x0D,0x1A,0x29,0x00,

  0x0D,0x28,0x26,0x00,	// enemy sprites
  0x0D,0x28,0x26,0x00,	// rescue person
  0x0D,0x28,0x26,0x00,
  0x0D,0x28,0x26	// player sprites; was 0x0D, 0x27, 0x2A
};
